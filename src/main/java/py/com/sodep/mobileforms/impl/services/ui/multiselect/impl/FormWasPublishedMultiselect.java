...
@Service("multiselect.formsWasPublished")
@Transactional
public class FormWasPublishedMultiselect extends BaseMultiselectService implements IMultiselectService {
	...
	public MultiselectServiceResponse listItems(MultiselectReadRequest request) {
		...
		PagedData<List<FormDTO>> pagedData = formService.findFormsThatWereOrArePubished(application, project, user,
				auth, filter, pageNumber, pageLength, language);
