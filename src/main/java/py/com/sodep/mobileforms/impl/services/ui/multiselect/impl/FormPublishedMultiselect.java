...
@Service("multiselect.formsPublished")
@Transactional
public class FormPublishedMultiselect extends BaseMultiselectService implements IMultiselectService {
	...
	public MultiselectServiceResponse listItems(MultiselectReadRequest request) {
		...
		int pageSize = request.getPageLength();
		String filter = request.getFilter();

		String auth = AuthorizationNames.Form.INPUT_DATA_WEB;
		Map<String, String> params = request.getParams();

		Project project = null;
		if (params != null && params.get("project") != null) { // Forms for a
																// given project
		...
		PagedData<List<FormDTO>> pagedData = formService.findAllPublished(application, project, user, auth,filter, page, pageSize, language);
