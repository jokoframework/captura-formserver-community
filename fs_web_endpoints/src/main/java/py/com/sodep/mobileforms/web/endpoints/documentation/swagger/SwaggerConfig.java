...
public class SwaggerConfig {
	...
	public static final List<String> DEFAULT_INCLUDE_PATTERNS = Arrays.asList("/metadata/.*", "/lookupTable/.*",
			"/document.*", "/public/mobile/.*", "/public/ping", "/authentication/.*", "/workflow/.*");
	...
	private ApiInfo apiInfo() {
		ApiInfo apiInfo = new ApiInfo("Captura API", "API for Clients. Mobile applications and more!",
				"https://www.sodep.com.py/captura", "captura@sodep.com.py", "", "");
		return apiInfo;
	}
